# genpark-codebase-semantic-ast-symbol-indexer-context-skill
...
> **GenPark AI Agent Skill** -- Codebase semantic AST symbol indexer and inline edit context builder (Cursor style)
